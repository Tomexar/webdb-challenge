...
1. Explain the difference between `RDBMS` and `SQL`.
    ...
    RDBMS is the database and SQL is the language used to interact with that database

1. Why do tables need a `primary key`?

  A primary key is what is used to call the value for each column in the table 
